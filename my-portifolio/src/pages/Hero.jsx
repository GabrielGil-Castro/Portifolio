...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-200 to-cyan-100 flex items-center justify-center relative overflow-hidden"
    >
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center space-y-8">
          ...
          <p className="text-slate-800 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            inovadoras. Especializado em React, Node.js e tecnologias modernas
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              download
              className="border border-slate-600 text-slate-900 hover:text-white hover:border-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:bg-cyan-600"
            >
              Baixar CV
            </a>
          </div>
